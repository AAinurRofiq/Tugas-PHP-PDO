...
<html>
  <head>
    <title>PDO Achmad Ainur Rofiq</title>
    <!-- load css boostrap -->
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column" style="margin-top:100px;">
              ...
              <li class="nav-item">
                <a class="nav-link" href="insertcustomer.php">Tambah Data Customer</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="insertproduct.php">Tambah Data Product</a>
              </li>
            </ul>
          </div>
        </nav>
                ...
                <?php 
                 ...
                 <?php while($data = $result->fetch(PDO::FETCH_ASSOC) ): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo "updatecustomer.php?id=".$data['customerNumber']; ?>" class="btn btn-outline-warning btn-sm"> Update</a>
                      &nbsp;&nbsp;
                      <a href="<?php echo "deletecustomer.php?id=".$data['customerNumber']; ?>" class="btn btn-outline-danger btn-sm"> Delete</a>
                    </td>
                  </tr>
                 <?php endwhile ?>
              </tbody>
